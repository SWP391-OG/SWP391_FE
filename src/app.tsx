...
import IssueSelectionPage from './pages/student/issue-selection-page';
import CreateTicketPage from './pages/student/create-ticket-page';
import TicketListPage from './pages/student/ticket-list-page';
...
function App() {
  ...
  const [studentTab, setStudentTab] = useState<'pending' | 'processing' | 'completed'>('pending');
          ...
          <div className="max-w-[1400px] mx-auto p-8">
            ...
            {studentView === 'create-ticket' && selectedIssue && (
              <CreateTicketPage
                ...
                onSubmit={(ticketData: Omit<Ticket, 'id' | 'createdAt' | 'slaDeadline'>) => {
                  ...
                  // Add ticket to state (will auto-save to localStorage via useEffect)
