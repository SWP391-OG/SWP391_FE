  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Trang Facility Staff</h2>
        <p className="text-gray-600">Bạn đang ở trang dành cho Facility Staff</p>
      </div>
      
      <div className="bg-white rounded-xl p-12 text-center shadow-sm border-2 border-gray-100 max-w-3xl mx-auto">
        <div className="text-6xl mb-6">🔧</div>
        <h3 className="text-2xl font-bold text-gray-900 mb-4">Chức năng dành cho Facility Staff</h3>
        <p className="text-gray-600 text-lg leading-relaxed max-w-lg mx-auto">
          Facility Staff xử lý các ticket về AC, Điện, Nước được Facility Admin giao cho mình.
        </p>
